...
public class WorkWithDailyTasksCaseFourTest extends BaseMobileClass {
    ...
    //Стол31
        ...
        receptionCardPage.inputSN("normal","31FRAGSN31Series0131122021", 10);
...
//        receptionCardPage.clickButton("commitSN");
    ...
    //Стол32
        ...
        receptionCardPage.inputSN("normal","32FRAGSN32Series0131122021", 10);
...
//        receptionCardPage.clickButton("commitSN");
    ...
    //Стол33
        ...
        receptionCardPage.verifyData("productInfoSN", "00033 30.11.2022 Стол33");
        receptionCardPage.inputSN("normal","33FRAGSN33Series0131122021", 10);
...
//        receptionCardPage.getQtySerialNumber(2).shouldHave(exactText("10"));
//        receptionCardPage.clickButton("commitSN");
        receptionCardPage.verifyData("productInfo", "00033 30.11.2022 Стол33 IN.01 Quantity 10 шт");
        receptionCardPage.verifyData("qty", "10");
        receptionCardPage.clickButton("commit");
    //Стол34
        ...
        receptionCardPage.inputSN("normal","34FRAGSN34Series0131122021", 10);
